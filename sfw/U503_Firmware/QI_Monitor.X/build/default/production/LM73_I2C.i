...
output_data_array[0] = 0x01;
output_data_array[1] = 0b01000000;
length = 2;
I2C2_MasterWrite(output_data_array, length, 0x4D, &I2C_STATUS);
while(I2C_STATUS == I2C2_MESSAGE_PENDING);
...
error_handler.I2C_QI_Temp_Sense_error_flag = 1;
}


I2C2_MasterWrite(output_data_array, length, 0x4C, &I2C_STATUS);
while(I2C_STATUS == I2C2_MESSAGE_PENDING);
if ( I2C_STATUS == I2C2_MESSAGE_FAIL ||
I2C_STATUS == I2C2_STUCK_START ||
I2C_STATUS == I2C2_MESSAGE_ADDRESS_NO_ACK ||
I2C_STATUS == I2C2_DATA_NO_ACK ||
I2C_STATUS == I2C2_LOST_STATE ) {
error_handler.I2C_POS5_Temp_Sense_error_flag = 1;
}


I2C2_MasterWrite(output_data_array, length, 0x4E, &I2C_STATUS);
while(I2C_STATUS == I2C2_MESSAGE_PENDING);
if ( I2C_STATUS == I2C2_MESSAGE_FAIL ||
I2C_STATUS == I2C2_STUCK_START ||
I2C_STATUS == I2C2_MESSAGE_ADDRESS_NO_ACK ||
I2C_STATUS == I2C2_DATA_NO_ACK ||
I2C_STATUS == I2C2_LOST_STATE ) {
error_handler.I2C_Ambient_Temp_Sense_error_flag = 1;
}


output_data_array[0] = 0x04;
output_data_array[1] = 0b11100000;
length = 2;
I2C2_MasterWrite(output_data_array, length, 0x4D, &I2C_STATUS);
while(I2C_STATUS == I2C2_MESSAGE_PENDING);
if ( I2C_STATUS == I2C2_MESSAGE_FAIL ||
...
I2C2_MasterWrite(0x00, 1, 0x4D, &I2C_STATUS);
while(I2C_STATUS == I2C2_MESSAGE_PENDING);
if ( I2C_STATUS == I2C2_MESSAGE_FAIL ||
I2C_STATUS == I2C2_STUCK_START ||
I2C_STATUS == I2C2_MESSAGE_ADDRESS_NO_ACK ||
...
I2C2_MasterRead(LM73_temp_results.QI_data_raw, 2, 0x4D, &I2C_STATUS);
while(I2C_STATUS == I2C2_MESSAGE_PENDING);
if ( I2C_STATUS == I2C2_MESSAGE_FAIL ||
I2C_STATUS == I2C2_STUCK_START ||
I2C_STATUS == I2C2_MESSAGE_ADDRESS_NO_ACK ||
...
I2C2_MasterWrite(0x00, 1, 0x4C, &I2C_STATUS);
while(I2C_STATUS == I2C2_MESSAGE_PENDING);
if ( I2C_STATUS == I2C2_MESSAGE_FAIL ||
I2C_STATUS == I2C2_STUCK_START ||
I2C_STATUS == I2C2_MESSAGE_ADDRESS_NO_ACK ||
...
I2C2_MasterRead(LM73_temp_results.POS5_data_raw, 2, 0x4C, &I2C_STATUS);
while(I2C_STATUS == I2C2_MESSAGE_PENDING);
if ( I2C_STATUS == I2C2_MESSAGE_FAIL ||
I2C_STATUS == I2C2_STUCK_START ||
I2C_STATUS == I2C2_MESSAGE_ADDRESS_NO_ACK ||
...
I2C2_MasterWrite(0x00, 1, 0x4E, &I2C_STATUS);
while(I2C_STATUS == I2C2_MESSAGE_PENDING);
if ( I2C_STATUS == I2C2_MESSAGE_FAIL ||
I2C_STATUS == I2C2_STUCK_START ||
I2C_STATUS == I2C2_MESSAGE_ADDRESS_NO_ACK ||
...
I2C2_MasterRead(LM73_temp_results.Ambient_data_raw, 2, 0x4E, &I2C_STATUS);
while(I2C_STATUS == I2C2_MESSAGE_PENDING);
if ( I2C_STATUS == I2C2_MESSAGE_FAIL ||
I2C_STATUS == I2C2_STUCK_START ||
I2C_STATUS == I2C2_MESSAGE_ADDRESS_NO_ACK ||
