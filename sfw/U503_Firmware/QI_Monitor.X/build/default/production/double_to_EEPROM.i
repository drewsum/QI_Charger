...
eeprom_ram_aliases.POS12_Max_Result = readFloatFromEEPROM(0x0000);
eeprom_ram_aliases.POS12_Min_Result = readFloatFromEEPROM(0x0004);
eeprom_ram_aliases.POS5_Max_Result = readFloatFromEEPROM(0x0008);
eeprom_ram_aliases.POS5_Min_Result = readFloatFromEEPROM(0x000C);
eeprom_ram_aliases.POS12_Current_Max_Result = readFloatFromEEPROM(0x0010);
eeprom_ram_aliases.POS12_Current_Min_Result = readFloatFromEEPROM(0x0014);
eeprom_ram_aliases.QI_Current_Max_Result = readFloatFromEEPROM(0x0018);
eeprom_ram_aliases.QI_Current_Min_Result = readFloatFromEEPROM(0x001C);
eeprom_ram_aliases.Input_Power_Max_Result = readFloatFromEEPROM(0x0020);
eeprom_ram_aliases.Input_Power_Min_Result = readFloatFromEEPROM(0x0024);
eeprom_ram_aliases.Output_Power_Max_Result = readFloatFromEEPROM(0x0028);
eeprom_ram_aliases.Output_Power_Min_Result = readFloatFromEEPROM(0x002C);
eeprom_ram_aliases.Efficiency_Max_Result = readFloatFromEEPROM(0x0030);
eeprom_ram_aliases.Efficiency_Min_Result = readFloatFromEEPROM(0x0034);
eeprom_ram_aliases.Load_Energy_Max_Result = readFloatFromEEPROM(0x0038);
eeprom_ram_aliases.Load_Charge_Max_Result = readFloatFromEEPROM(0x003C);
eeprom_ram_aliases.QI_FSW_Max_Result = readFloatFromEEPROM(0x0040);
eeprom_ram_aliases.QI_FSW_Min_Result = readFloatFromEEPROM(0x0044);
eeprom_ram_aliases.QI_Temp_Max_Result = readFloatFromEEPROM(0x0048);
eeprom_ram_aliases.QI_Temp_Min_Result = readFloatFromEEPROM(0x004C);
eeprom_ram_aliases.POS5_Temp_Max_Result = readFloatFromEEPROM(0x0050);
eeprom_ram_aliases.POS5_Temp_Min_Result = readFloatFromEEPROM(0x0054);
eeprom_ram_aliases.Ambient_Temp_Max_Result = readFloatFromEEPROM(0x0058);
eeprom_ram_aliases.Ambient_Temp_Min_Result = readFloatFromEEPROM(0x005C);
eeprom_ram_aliases.Die_Temp_Max_Result = readFloatFromEEPROM(0x0060);
eeprom_ram_aliases.Die_Temp_Min_Result = readFloatFromEEPROM(0x0064);
...
if (eeprom_ram_aliases.POS12_Max_Result > readFloatFromEEPROM(0x0000)) writeFloatToEEPROM(eeprom_ram_aliases.POS12_Max_Result, 0x0000);
if (eeprom_ram_aliases.POS12_Min_Result < readFloatFromEEPROM(0x0004)) writeFloatToEEPROM(eeprom_ram_aliases.POS12_Min_Result, 0x0004);


if (eeprom_ram_aliases.POS5_Max_Result > readFloatFromEEPROM(0x0008)) writeFloatToEEPROM(eeprom_ram_aliases.POS12_Max_Result, 0x0000);
if (eeprom_ram_aliases.POS5_Min_Result < readFloatFromEEPROM(0x000C)) writeFloatToEEPROM(eeprom_ram_aliases.POS5_Min_Result, 0x000C);


if (eeprom_ram_aliases.POS12_Current_Max_Result > readFloatFromEEPROM(0x0010)) writeFloatToEEPROM(eeprom_ram_aliases.POS12_Current_Max_Result, 0x0010);
if (eeprom_ram_aliases.POS12_Current_Min_Result < readFloatFromEEPROM(0x0014)) writeFloatToEEPROM(eeprom_ram_aliases.POS12_Current_Min_Result, 0x0014);


if (eeprom_ram_aliases.QI_Current_Max_Result > readFloatFromEEPROM(0x0018)) writeFloatToEEPROM(eeprom_ram_aliases.QI_Current_Max_Result, 0x0018);
if (eeprom_ram_aliases.QI_Current_Min_Result < readFloatFromEEPROM(0x001C)) writeFloatToEEPROM(eeprom_ram_aliases.QI_Current_Min_Result, 0x001C);


if (eeprom_ram_aliases.Input_Power_Max_Result > readFloatFromEEPROM(0x0020)) writeFloatToEEPROM(eeprom_ram_aliases.Input_Power_Max_Result, 0x0020);
if (eeprom_ram_aliases.Input_Power_Min_Result < readFloatFromEEPROM(0x0024)) writeFloatToEEPROM(eeprom_ram_aliases.Input_Power_Min_Result, 0x0024);


if (eeprom_ram_aliases.Output_Power_Max_Result > readFloatFromEEPROM(0x0028)) writeFloatToEEPROM(eeprom_ram_aliases.Output_Power_Max_Result, 0x0028);
if (eeprom_ram_aliases.Output_Power_Min_Result < readFloatFromEEPROM(0x002C)) writeFloatToEEPROM(eeprom_ram_aliases.Output_Power_Min_Result, 0x002C);


if (eeprom_ram_aliases.Efficiency_Max_Result > readFloatFromEEPROM(0x0030)) writeFloatToEEPROM(eeprom_ram_aliases.Efficiency_Max_Result, 0x0030);
if (eeprom_ram_aliases.Efficiency_Min_Result < readFloatFromEEPROM(0x0034)) writeFloatToEEPROM(eeprom_ram_aliases.Efficiency_Min_Result, 0x0034);


if (eeprom_ram_aliases.Load_Energy_Max_Result > readFloatFromEEPROM(0x0038)) writeFloatToEEPROM(eeprom_ram_aliases.Load_Energy_Max_Result, 0x0038);


if (eeprom_ram_aliases.Load_Charge_Max_Result > readFloatFromEEPROM(0x003C)) writeFloatToEEPROM(eeprom_ram_aliases.Load_Charge_Max_Result, 0x003C);


if (eeprom_ram_aliases.QI_FSW_Max_Result > readFloatFromEEPROM(0x0040)) writeFloatToEEPROM(eeprom_ram_aliases.QI_FSW_Max_Result, 0x0040);
if (eeprom_ram_aliases.QI_FSW_Min_Result < readFloatFromEEPROM(0x0044)) writeFloatToEEPROM(eeprom_ram_aliases.QI_FSW_Min_Result, 0x0044);


if (eeprom_ram_aliases.QI_Temp_Max_Result > readFloatFromEEPROM(0x0048)) writeFloatToEEPROM(eeprom_ram_aliases.QI_Temp_Max_Result, 0x0048);
if (eeprom_ram_aliases.QI_Temp_Min_Result < readFloatFromEEPROM(0x004C)) writeFloatToEEPROM(eeprom_ram_aliases.QI_Temp_Min_Result, 0x004C);


if (eeprom_ram_aliases.POS5_Temp_Max_Result > readFloatFromEEPROM(0x0050)) writeFloatToEEPROM(eeprom_ram_aliases.POS5_Temp_Max_Result, 0x0050);
if (eeprom_ram_aliases.POS5_Temp_Min_Result < readFloatFromEEPROM(0x0054)) writeFloatToEEPROM(eeprom_ram_aliases.POS5_Temp_Min_Result, 0x0054);


if (eeprom_ram_aliases.Ambient_Temp_Max_Result > readFloatFromEEPROM(0x0058)) writeFloatToEEPROM(eeprom_ram_aliases.Ambient_Temp_Max_Result, 0x0058);
if (eeprom_ram_aliases.Ambient_Temp_Min_Result < readFloatFromEEPROM(0x005C)) writeFloatToEEPROM(eeprom_ram_aliases.Ambient_Temp_Min_Result, 0x005C);


if (eeprom_ram_aliases.Die_Temp_Max_Result > readFloatFromEEPROM(0x0060)) writeFloatToEEPROM(eeprom_ram_aliases.Die_Temp_Max_Result, 0x0060);
if (eeprom_ram_aliases.Die_Temp_Min_Result < readFloatFromEEPROM(0x0064)) writeFloatToEEPROM(eeprom_ram_aliases.Die_Temp_Min_Result, 0x0064);
...
writeFloatToEEPROM(eeprom_ram_aliases.POS12_Max_Result, 0x0000);
writeFloatToEEPROM(eeprom_ram_aliases.POS12_Min_Result, 0x0004);
writeFloatToEEPROM(eeprom_ram_aliases.POS5_Max_Result, 0x0008);
writeFloatToEEPROM(eeprom_ram_aliases.POS5_Min_Result, 0x000C);
writeFloatToEEPROM(eeprom_ram_aliases.POS12_Current_Max_Result, 0x0010);
writeFloatToEEPROM(eeprom_ram_aliases.POS12_Current_Min_Result, 0x0014);
writeFloatToEEPROM(eeprom_ram_aliases.QI_Current_Max_Result, 0x0018);
writeFloatToEEPROM(eeprom_ram_aliases.QI_Current_Min_Result, 0x001C);
writeFloatToEEPROM(eeprom_ram_aliases.Input_Power_Max_Result, 0x0020);
writeFloatToEEPROM(eeprom_ram_aliases.Input_Power_Min_Result, 0x0024);
writeFloatToEEPROM(eeprom_ram_aliases.Output_Power_Max_Result, 0x0028);
writeFloatToEEPROM(eeprom_ram_aliases.Output_Power_Min_Result, 0x002C);
writeFloatToEEPROM(eeprom_ram_aliases.Efficiency_Max_Result, 0x0030);
writeFloatToEEPROM(eeprom_ram_aliases.Efficiency_Min_Result, 0x0034);
writeFloatToEEPROM(eeprom_ram_aliases.Load_Energy_Max_Result, 0x0038);
writeFloatToEEPROM(eeprom_ram_aliases.Load_Charge_Max_Result, 0x003C);
writeFloatToEEPROM(eeprom_ram_aliases.QI_FSW_Max_Result, 0x0040);
writeFloatToEEPROM(eeprom_ram_aliases.QI_FSW_Min_Result, 0x0044);
writeFloatToEEPROM(eeprom_ram_aliases.QI_Temp_Max_Result, 0x0048);
writeFloatToEEPROM(eeprom_ram_aliases.QI_Temp_Min_Result, 0x004C);
writeFloatToEEPROM(eeprom_ram_aliases.POS5_Temp_Max_Result, 0x0050);
writeFloatToEEPROM(eeprom_ram_aliases.POS5_Temp_Min_Result, 0x0054);
writeFloatToEEPROM(eeprom_ram_aliases.Ambient_Temp_Max_Result, 0x0058);
writeFloatToEEPROM(eeprom_ram_aliases.Ambient_Temp_Min_Result, 0x005C);
writeFloatToEEPROM(eeprom_ram_aliases.Die_Temp_Max_Result, 0x0060);
writeFloatToEEPROM(eeprom_ram_aliases.Die_Temp_Min_Result, 0x0064);
