...
error_handler.FVR_ADC_error_flag = 1;
...
if (pos12_isns_average_index == 16) {
...
adc_results.pos12_isns_adc_result /= (float) 16;
}
...
adc_results.qi_isns_adc_result /= (float) 16;
}
...
default:
error_handler.ADC_general_error_flag = 1;
break;
